...
/* harmony import */ var _lib_config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lib/_config */ "./src/js/lib/_config.js");
...
var _controls = {
  ...
  btnOk: _lib_jquery_with_plugins__WEBPACK_IMPORTED_MODULE_0___default()('#btnOk'),
  classTerms: _lib_jquery_with_plugins__WEBPACK_IMPORTED_MODULE_0___default()('.terms')
}; //------------------------------------------------------------------//
...
_lib_jquery_with_plugins__WEBPACK_IMPORTED_MODULE_0___default()(window).on('_ready', function () {
  // 部分ページの読込
  var path = "".concat(_lib_config__WEBPACK_IMPORTED_MODULE_5__["default"].assets.terms);

  _controls.classTerms.load(path);

  var href = _lib_utiltity__WEBPACK_IMPORTED_MODULE_6__.isConfirm() ? 'home.html' : 'changePassword.html';
  var title = _lib_utiltity__WEBPACK_IMPORTED_MODULE_6__.isConfirm() ? '利用規約' : '利用規約';
  var h1 = _lib_utiltity__WEBPACK_IMPORTED_MODULE_6__.isConfirm() ? '利用規約' : '利用規約';
  var btnText = _lib_utiltity__WEBPACK_IMPORTED_MODULE_6__.isConfirm() ? 'ホーム' : '同意する';
  ...
  _controls.btnOk.on('click', function () {
    location.href = href;
  });
});
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendor"], function() { return __webpack_require__("./src/js/terms.js"); })
