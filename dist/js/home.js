...
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_config */ "./src/js/_config.js");
/* harmony import */ var _localStorage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./_localStorage */ "./src/js/_localStorage.js");
/* harmony import */ var _sessionStorage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./_sessionStorage */ "./src/js/_sessionStorage.js");
/* harmony import */ var _cognito__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./_cognito */ "./src/js/_cognito.js");
...
var _username = (0,_cognito__WEBPACK_IMPORTED_MODULE_8__.getCurrentUser)().username;
$(window).on('_ready', function () {
  $(window).trigger('_refresh'); // 日付(YYYYMMDD)の保存
  // todo:5 ホーム画面の表示日時は本日を基本にする

  var fdate = (0,_utiltity__WEBPACK_IMPORTED_MODULE_4__.getParam)('date');

  if (!fdate) {
    var fnow = moment().format('YYYYMMDD');
    fdate = fnow;
  }
...
var refresh = function refresh(value) {
  ...
  window._config.currentFormatDate = fdate;
  $(window).trigger('_refresh'); // todo:1 未来の入力は不可
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            obj = null;
            url = window._config.api.getCondition;
            json = {
              username: username,
              startDate: date,
              endDate: date
            ...
            _context.next = 6;
            return (0,_utiltity__WEBPACK_IMPORTED_MODULE_4__.getApiAsync)(url, json).then(function (x) {
          ...
          case 6:
            ...
            defs.forEach(function (x) {
              ...
              if (!isNull(x.data)) {
                $("#".concat(x.id)).text("".concat(x.data.toLocaleString()));
                $("#".concat(x.id)).addClass('text-success');
              } else {
                $("#".concat(x.id)).text("---");
                $("#".concat(x.id)).addClass('home-item-text-mute');
              }
            });
            drawRefresh();
