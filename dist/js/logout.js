...
/* harmony export */   "default": function() { return /* binding */ AppSessionStorage; }
/* harmony export */ });
 ...
 * セッションストレージの管理
 */
var AppSessionStorage = /*#__PURE__*/function () {
  function AppSessionStorage() {
    _classCallCheck(this, AppSessionStorage);
  }

  _createClass(AppSessionStorage, null, [{
    key: "getUser",
    value: // ユーザ名の取得
    function getUser() {
    ...
    key: "setFormatDate",
    value: function setFormatDate(value) {
    ...
    key: "setKeyword",
    value: function setKeyword(value) {
      sessionStorage.setItem(this.config.keyword, value);
    } // 検索キーワードの削除

  }, {
    key: "removeKeyword",
    value: function removeKeyword() {
...
_defineProperty(AppSessionStorage, "config", {
  user: 'currentUser',
...
/* harmony import */ var _lib_localStorage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./lib/_localStorage */ "./src/js/lib/_localStorage.js");
/* harmony import */ var _lib_sessionStorage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./lib/_sessionStorage */ "./src/js/lib/_sessionStorage.js");
...
_lib_jquery_with_plugins__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  (0,_lib_startup__WEBPACK_IMPORTED_MODULE_4__["default"])(!(0,_lib_cognito__WEBPACK_IMPORTED_MODULE_8__.isSignIn)());
  onSignOut();
}); // サインアウト

var onSignOut = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_lib_cognito__WEBPACK_IMPORTED_MODULE_8__.signOut)();

          case 2:
            _lib_sessionStorage__WEBPACK_IMPORTED_MODULE_7__["default"].removeAll();
            _lib_localStorage__WEBPACK_IMPORTED_MODULE_6__["default"].removeAll();
            _lib_jquery_with_plugins__WEBPACK_IMPORTED_MODULE_0___default()(window).delay(3000).queue(function () {
              _lib_utiltity__WEBPACK_IMPORTED_MODULE_5__.gotoLoginPage();
            });
